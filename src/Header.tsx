...
// PG_CHANGED: we use the same logo as LogoType.svg instead of "Logo.svg"
import Logo from "./icons/LogoType.svg?react";
...
export const HeaderLogo: FC<HeaderLogoProps> = ({ className }) => {
  ...
  return (
    ...
    >
      <Logo />
      {/* PG_CHANGED: remove logo -> add our own logo when we have it */}
    </Link>
  );
};
