...
describe("useMuteStates VITE_PACKAGE='full' (SPA) mode", () => {
  ...
  // PG_CHANGED
  it("does not mute audio by default even in the call", () => {
    // Note: We now keep microphone unmuted by default even when already joined
    mockConfig();
  ...
  // PG_CHANGED
  it("skipLobby does not mute inputs by default", () => {
    mockConfig();
